...
token is used for authentication. its a string of code that holds information. it is saved locally then when a user goes on the site it checks the token and lets them in or doesn't if its the wrong token. 

- [ ] What steps can you take in your web apps to keep your data secure?

set up authentication and have a good password system to protect sensitive data

- [ ] Describe how web servers work.

Web servers are a program that runs on computers to have ability to interact with other computers using certain networking methods.
